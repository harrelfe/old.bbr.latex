...
\subsection{Graphing Change vs.\ Raw Data}\label{sec:descript-change}
...
\fig{desc-proportions-txreg}{Dot chart for categorical demographic
  variables, stratified by treatment and region}{1}

\fig{aevents}{Dot chart showing proportion of subjects having adverse
...
\centerline{\includegraphics{descript-glybox-1} }
...
\fig{cchem-byx-cont-a}{One-half violin plots for longitudinal data, stratified
...
\hline
\endfoot
Intercept&~-0.2884~&~0.0048~&-60.45&$<0.0001$\tabularnewline
age&~ 0.0002~&~0.0001~&  3.34&0.0008\tabularnewline
age'&~ 0.0010~&~0.0001~&  7.63&$<0.0001$\tabularnewline
age''&~-0.0040~&~0.0005~& -8.33&$<0.0001$\tabularnewline
re=Other Hispanic&~-0.0013~&~0.0011~& -1.20&0.2318\tabularnewline
re=Non-Hispanic White&~-0.0082~&~0.0008~&-10.55&$<0.0001$\tabularnewline
...
sex=female&~-0.0022~&~0.0006~& -3.90&$<0.0001$\tabularnewline
bmi&~-0.0006~&~0.0002~& -2.54&0.0111\tabularnewline
bmi'&~ 0.0059~&~0.0009~&  6.44&$<0.0001$\tabularnewline
bmi''&~-0.0161~&~0.0025~& -6.40&$<0.0001$\tabularnewline
\hline
\end{longtable}
