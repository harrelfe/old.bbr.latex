...
\centerline{\includegraphics{reg-olslead-1} }
...
anova(fa)
\end{Sinput}
%latex.default(dstats, title = title, caption = if (table.env) caption else NULL,     rowlabel = "", col.just = rep("r", length(sn)), table.env = table.env,     ...)%
\begin{center}
...
\disc{reg-val}
\blog{2017/01/split-sample-model-validation.html}
