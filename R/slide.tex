...
excellent graphical front-end \Co{RStudio} (\url{rstudio.org}) that
...
\item Use \co{RStudio} (\url{rstudio.org}) to run \R
\ee
...
\item Install \co{RStudio} from \url{rstudio.org} or update your
...
are \co{Ctrl+Alt+C} and \co{Ctrl+Alt+N}.  You can also click on a
...
Here is another example where the there is a \co{junk} variable to
...
23 (1, 25%), 37 (1, 25%), 42 (1, 25%), 45 (1, 25%) 
---------------------------------------------------------------------------
sbp : Systolic Blood Pressure [mmHg] 
      n missing  unique    Info    Mean 
      4       0       4       1   134.8 

127 (1, 25%), 131 (1, 25%), 140 (1, 25%), 141 (1, 25%) 
---------------------------------------------------------------------------
sex 
      n missing  unique 
      4       0       2 

female (2, 50%), male (2, 50%) 
---------------------------------------------------------------------------
state 
      n missing  unique 
      4       0       2 

Alabama (2, 50%), Alaska (2, 50%) 
---------------------------------------------------------------------------
\end{Soutput}
\begin{Sinput}
