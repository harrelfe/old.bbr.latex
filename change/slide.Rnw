...
Stephen Senn~\cite{sensta} Chapter 7 has a very useful graphical summary of the large-sample variances (inefficiency) of change scores vs.\ ANCOVA vs.\ ignoring baseline completely, as a function of the (assumed linear) correlation between baseline and outcome.
